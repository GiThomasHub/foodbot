...
def main():
    ...
    app.add_handler(ConversationHandler(
        ...
        states={
            ...
            BEILAGEN_SELECT:   [CallbackQueryHandler(beilage_select_cb,  pattern=r"^beilage_(\d+|done)$")],
    ...
    app.add_handler(ConversationHandler(
        entry_points=[
            ...
            #CallbackQueryHandler(fav_add_start, pattern="^favoriten$")   gelöscht am 23/9, weil im globalen handler bereits drin...
        ],
        states={
            FAV_OVERVIEW: [
