...
MENU_INPUT, ASK_BEILAGEN, SELECT_MENUES, BEILAGEN_SELECT, ASK_FINAL_LIST, ASK_SHOW_LIST, FERTIG_PERSONEN, REZEPT_INDEX, REZEPT_PERSONEN, TAUSCHE_SELECT, TAUSCHE_CONFIRM, ASK_CONFIRM, EXPORT_OPTIONS, FAV_OVERVIEW, FAV_DELETE_SELECT, PDF_EXPORT_CHOICE = range(16)
...
def main():
    ...
    app.add_handler(ConversationHandler(
        ...
        states={
            ...
            PDF_EXPORT_CHOICE: [
                CallbackQueryHandler(process_pdf_export_choice, pattern="^pdf_export_"),
            ],
        },
