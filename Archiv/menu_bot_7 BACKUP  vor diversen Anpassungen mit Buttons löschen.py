...
async def quickone_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Nur bei erstem Aufruf (/quickone oder start_quickone) Pool zurücksetzen
    ...
    # … restlicher Code für Buttons und Rückgabe QUICKONE_CONFIRM …
